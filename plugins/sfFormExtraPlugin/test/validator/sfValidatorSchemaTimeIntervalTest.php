...
// clean()
$t->diag ( 'clean()' );
$v = new sfValidatorSchemaTimeInterval ( 'start', 'end', array (
...
try {
	$v->clean ( array (
			'start' => date ( 'Y-m-d', time () + (365 * 24 * 3600) ),
			'end' => date ( 'Y-m-d', time () + (366 * 24 * 3600) ) ) );
