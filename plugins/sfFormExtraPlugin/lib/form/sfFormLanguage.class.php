...
class sfFormLanguage extends sfForm {
	 ...
	 *
	 * @param
	 *        	sfUser A sfUser instance
	 * @param
	 *        	array An array of options
	 * @param
	 *        	string A CSRF secret (false to disable CSRF protection, null to use the global CSRF secret)
	 *        	
	 * @see sfForm
	 */
	public function __construct(sfUser $user, $options = array(), $CSRFSecret = null) {
		...
		parent::__construct ( array (
				'language' => $user->getCulture () ), $options, $CSRFSecret );
	}
	 ...
	 *
	 * @param
	 *        	sfRequest A sfRequest instance
	 *        	
	...
	public function configure() {
		...
		$this->setWidgets ( array (
				'language' => new sfWidgetFormI18nChoiceLanguage ( array (
