...
class sfWidgetFormPropelChoiceGrouped extends sfWidgetFormPropelChoice {
	...
	public function getChoices() {
		...
		if ($order = $this->getOption ( 'order_by' )) {
			...
			$criteria->$method ( call_user_func ( array (
					$class,
					'translateFieldName' ), $order [0], BasePeer::TYPE_PHPNAME, BasePeer::TYPE_COLNAME ) );
		}
		...
		$objects = call_user_func ( array (
				$class,
				$peerMethod ), $criteria, $this->getOption ( 'connection' ) );
