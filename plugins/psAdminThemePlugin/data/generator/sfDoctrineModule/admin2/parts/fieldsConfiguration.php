...
<?php unset($this->config['list']['title']) ?>
  ...
  {
    return '<?php echo $this->escapeString(isset($this->config['detail']['title']) ? $this->config['detail']['title'] : 'Detail '.sfInflector::humanize($this->getModuleName())) ?>';
<?php unset($this->config['detail']['title']) ?>
  }
