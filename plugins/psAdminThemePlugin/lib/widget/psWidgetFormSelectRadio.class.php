 ...
 */
class psWidgetFormSelectRadio extends sfWidgetFormChoiceBase
{
  /**
   * Constructor.
   *
  ...
  protected function configure($options = array(), $attributes = array())
  {
    ...
    $this->addOption('class', 'inline-group');
    ...
    foreach ($choices as $key => $option)
    {
      ...
      $inputs[$id] = array(
        //'input' => $this->renderTag('input', array_merge($baseAttributes, $attributes)),
      	...
      	'input' => $this->renderContentTag('label', $this->renderTag('input', array_merge($baseAttributes, $attributes), array('class' => 'radiobox')).'<span>'.self::escapeOnce($option).'</span>', array('for' => $id, 'class' => 'radio radio-inline')),
      		
        'label' => $this->renderContentTag('label', self::escapeOnce($option), array('for' => $id, 'class' => 'radio radio-inline')),
      );
    }
