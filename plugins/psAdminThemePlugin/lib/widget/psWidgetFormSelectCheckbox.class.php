<?php
/**
 * psWidgetFormSelectCheckbox represents an array of checkboxes.
 *
 * @package    symfony
 * @subpackage widget
 ...
 * @version    1.0
 */
class psWidgetFormSelectCheckbox extends sfWidgetFormChoiceBase
{
  /**
   * Constructor.
   *
  ...
  protected function formatChoices($name, $value, $choices, $attributes)
  {
    ...
    foreach ($choices as $key => $option)
    {
      ...
      $inputs[$id] = array(
        'input' => $this->renderTag('input', array_merge($baseAttributes, $attributes)).'<i></i>',
