	...
	protected function transform(sfImage $image) {
		...
		if (! is_null ( $this->fill )) {
			if (! is_object ( $this->fill )) {
				imagefilledellipse ( $resource, $this->x, $this->y, $this->width, $this->height, $image->getAdapter ()
			...
			if ($this->color !== "" && $this->fill !== $this->color) {
				imageellipse ( $resource, $this->x, $this->y, $this->width, $this->height, $image->getAdapter ()
					->getColorByHex ( $resource, $this->color ) );
			}
		} 
		else {
