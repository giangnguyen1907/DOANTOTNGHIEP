...
class sfImageArcGD extends sfImageTransformAbstract {
	 ...
	 *        	height of arc
	 * @param integer $start_angle
	 *        	angle in degrees
	 * @param integer $end_angle
	 *        	angle in degrees
	 ...
	 *        	string color or fill object
	 * @param integer $style
	 *        	fill style, only applicable if using a fill object
	 */
	...
	protected function transform(sfImage $image) {
		...
		if (! is_null ( $this->fill )) {
			if (! is_object ( $this->fill )) {
				imagefilledarc ( $resource, $this->x, $this->y, $this->width, $this->height, $this->start_angle, $this->end_angle, $image->getAdapter ()
					->getColorByHex ( $resource, $this->fill ), $this->style );
			}

			if ($this->color !== "" && $this->fill !== $this->color) {
				imagearc ( $resource, $this->x, $this->y, $this->width, $this->height, $this->start_angle, $this->end_angle, $image->getAdapter ()
					->getColorByHex ( $resource, $this->color ) );
			}
		} 
		else {
