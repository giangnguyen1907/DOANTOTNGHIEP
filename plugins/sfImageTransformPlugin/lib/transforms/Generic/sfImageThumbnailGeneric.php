...
class sfImageThumbnailGeneric extends sfImageTransformAbstract {
	...
	/**
	 * method to be used for thumbnail creation.
	 * default is scale.
	 */
	 ...
	 *        	of the thumbnail
	 * @param
	 *        	string type of thumbnail method to be created
	 *        	
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	string thumbnail method. Options are scale (default), deflate (or inflate), right, left, top, bottom, scale
	 *        	
	 * @return integer
	 */
