...
class sfImageCallbackGeneric extends sfImageTransformAbstract {
	 ...
	 *        	of the thumbnail
	 * @param
	 *        	boolean could the target image be larger than the source ?
	 * @param
	 *        	boolean should the target image keep the source aspect ratio ?
	 *        	
	 * @return void
	 */
	...
	public function transform(sfImage $image) {
		...
		call_user_func_array ( $this->getFunction (), array (
				'image' => $image,
