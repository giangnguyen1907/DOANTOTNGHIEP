...
class sfImageTransformGDAdapter extends sfImageTransformAdapterAbstract {
	 ...
	 * Check for GD extension. An exception is thrown if not installed
	 *
	 ...
	 * @param
	 *        	string full hex value of the color or GD constant
	 * @return integer
	 */
	...
	/**
	 * Helper method.
	 * Returns a transparent image resource of the specified size
	 *
	 * @param
	 *        	integer width
	 * @param
	...
	public function getTransparentImage($w, $h) {
		...
		if (in_array ( $this->getMIMEType (), array (
				'image/gif',
				'image/png' ) )) {
