...
class sfImageTransformImageMagickAdapter extends sfImageTransformAdapterAbstract {
	 ...
	 * Check for imagick extension. An exception is thrown if not installed
	 *
	 * @throws sfImageTransformException
	 */
	...
	public function __toString() {
		...
		$this->getHolder ()
			->setImageCompressionQuality ( $this->getQuality () );
	...
	public function setMimeType($mime) {
		...
		if ($this->hasHolder () && isset ( $this->types [$mime] )) {
			$this->getHolder ()
				->setImageFormat ( $this->types [$mime] [0] );
