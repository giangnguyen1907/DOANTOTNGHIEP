...
class sfThumbnail {
	 ...
	 *
	 * @param
	 *        	int (optional) max width of thumbnail
	 * @param
	 *        	int (optional) max height of thumbnail
	 * @param
	 *        	boolean (optional) if true image scales
	 * @param
	 *        	boolean (optional) if true inflate small images
	 * @param
	 *        	string (optional) adapter class name
	 * @param
	 *        	array (optional) adapter options
	 */
	 ...
	 *
	 * @param
	 *        	string filename (with absolute path) of the image to load. If the filename is a http(s) URL, then an attempt to download the file will be made.
	 *        	
	...
	/**
	 * Loads an image from a string (e.g.
	 * database) and creates an internal thumbnail out of it
	 *
	 * @param
	 *        	string the image string (must be a format accepted by imagecreatefromstring())
	 * @param
	 ...
	 *
	 * @param
	 *        	string the image thumbnail file destination (with absolute path)
	 * @param
	 *        	string The mime-type of the thumbnail (possible values are 'image/jpeg', 'image/png', and 'image/gif')
	 *        	
	 * @access public
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	string The mime-type of the thumbnail (possible values are adapter dependent)
	 *        	
	 * @access public
	 * @return string
	 */
