$(document)
		.ready(
				function() {
								...
								setup : function(editor) {
									editor
											.on(
													...
													function(e) {
														$(
																'#ps_cms_articles_form')
																.formValidation(
																		'revalidateField',
																		'ps_cms_articles[description]');
													});
								},
								height : 500,
								selector : '#ps_cms_articles_description',
								indentation : '13px',
					...
					$('#ps_cms_articles_form').formValidation('setLocale',
							PS_CULTURE);
