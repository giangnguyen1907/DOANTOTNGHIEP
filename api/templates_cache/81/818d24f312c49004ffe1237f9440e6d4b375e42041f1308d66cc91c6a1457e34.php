...
class __TwigTemplate_5a60410f84f5f066e63df9baad4df9af644310534e5d352dcc3789694469234b extends Twig_Template
{
...
\t\t<p style=\"padding-bottom:20px;\"><a href='";
        // line 46
        echo twig_escape_filter($this->env, $this->getAttribute(($context["user"] ?? null), "link_reset", array()), "html", null, true);
...
Tin nhắn này được gửi tới <strong>";
        // line 62
        echo twig_escape_filter($this->env, $this->getAttribute(($context["user"] ?? null), "email_address", array()), "html", null, true);
