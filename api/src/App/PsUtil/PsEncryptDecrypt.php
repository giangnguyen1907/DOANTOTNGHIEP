...
class PsEncryptDecrypt {
    ...
    static public $cipher_mcrypt = MCRYPT_RIJNDAEL_128;
    static public $mode_mcrypt 	 = MCRYPT_DEV_URANDOM;
	 ...
	 * 
	 * @param $fieldName - field of table DB
	 * @param $keyEncrypt - key giai ma
	 * @return $string
	**/
