...
<td class="sf_admin_text sf_admin_list_td_app_device_id">
<strong>DeviceId:</strong> <?php echo $sf_guard_user->getAppDeviceId();?><br />
<strong>App token:</strong> <?php echo $sf_guard_user->getApiToken() ?><br />
<strong>OS:</strong> <?php echo $sf_guard_user->getOsname() ?><br />
<strong>Os vesion:</strong> <?php echo $sf_guard_user->getOsvesion() ?><br/>
