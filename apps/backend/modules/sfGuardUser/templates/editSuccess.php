	...
	<div class="row">
      ...
      <div class="jarviswidget" id="wid-id-0"
				...
				<header>
					...
					<h2><?php echo __('Editing user: %%first_name%% %%last_name%%', array('%%first_name%%' => $sf_guard_user->getFirstName(), '%%last_name%%' => $sf_guard_user->getLastName()), 'messages') ?></h2>
...
<script>
var password_old = '<?php echo $sf_guard_user->getPassword() ?>';
        		...
        		validators: {
                    ...
                    callback: {
                        ...
                        callback: function(value, validator, $field) {
                            ...
                            if(password_old !== value){ // Kiểm tra sự thay đổi password
