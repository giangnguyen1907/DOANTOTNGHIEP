...
<th class="sf_admin_date sf_admin_list_th_updated_at"
  ...
  <?php if ('updated_at' == $sort[0]): ?>
    <?php echo link_to(__('Updated by', array(), 'messages'), '@sf_guard_user', array('query_string' => 'sort=updated_at&sort_type='.($sort[1] == 'asc' ? 'desc' : 'asc'))) ?>
    <?php echo '<i class="fa fa-chevron-'.($sort[1] == 'asc' ? 'down' : 'up').' txt-color-greenDark" aria-hidden="true"></i>' ?>
  <?php else: ?>
    <?php echo link_to(__('Updated by', array(), 'messages'), '@sf_guard_user', array('query_string' => 'sort=updated_at&sort_type=asc')) ?>
  <?php endif; ?>
</th>
<?php end_slot(); ?>
...
?>
<th class="sf_admin_text sf_admin_list_th_app_device_id"
	<?php echo $data_hide; ?> <?php echo $style_order; ?>>
  <?php if ('app_device_id' == $sort[0]): ?>
    <?php echo link_to(__('App device', array(), 'messages'), '@sf_guard_user', array('query_string' => 'sort=app_device_id&sort_type='.($sort[1] == 'asc' ? 'desc' : 'asc'))) ?>
    <?php echo '<i class="fa fa-chevron-'.($sort[1] == 'asc' ? 'down' : 'up').' txt-color-greenDark" aria-hidden="true"></i>' ?>
  <?php else: ?>
    <?php echo link_to(__('App device', array(), 'messages'), '@sf_guard_user', array('query_string' => 'sort=app_device_id&sort_type=asc')) ?>
  <?php endif; ?>
</th>
<?php end_slot(); ?>
