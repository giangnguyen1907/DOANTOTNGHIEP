			...
			<div class="jarviswidget" id="wid-id-2"
				...
				<div>
					<div class="widget-body no-padding">
						...
						<form id="frm_batch"
							action="<?php echo url_for('@ps_logtime_trackbook_save') ?>"
							method="post">					
						<?php if($check_student_class):?>
					 	<div
							...
							<a
										...
										href="<?php echo url_for('@ps_student_info')?>"><i
					 	...
					 	<?php include_partial('psLogtimes/list_logtimes', array('month' => $month,'year' => $year, 'class_id' => $class_id,'student' => $student, 'list_relative' => $list_relative, 'list_member' => $list_member, 'student_logtime' => $student_logtime, 'ps_work_places' => $ps_work_places))?>
						<div
								class="sf_admin_actions dt-toolbar-footer no-border-transparent">
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 text-right">	
					    	<?php if ($sf_user->hasCredential(array(  0 => 'PS_STUDENT_ATTENDANCE_ADD',  1 => 'PS_STUDENT_ATTENDANCE_EDIT',))): ?>						
