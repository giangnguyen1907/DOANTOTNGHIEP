		...
		<?php include_partial('psLogtimes/flashes')?>
			<div class="jarviswidget" id="wid-id-0"
				...
				<header>
					...
					<h2><?php echo __('History service course comment', array(), 'messages') ?></h2>
				</header>
				<div>
					<div class="widget-body no-padding">
						<div class="dt-toolbar">
							<div class="col-xs-12 col-sm-12">
            			    <?php include_partial('psLogtimes/filters_history', array('formFilter' => $formFilter, 'helper' => $helper)) ?>
            			  </div>
						</div>
								...
								<table id="dt_basic"
            						...
            						<?php foreach ($filter_list_history as $list_history){ ?>
            							<tr>
											...
											<td>
                                            	<?php echo $list_history->getHistoryContent() ? sfOutputEscaperGetterDecorator::unescape($list_history->getHistoryContent()) : ''?>
                                            </td>
...
$(document).on("ready", function(){
	...
	var msg_select_student_id		= '<?php echo __('Please enter student filter the data.')?>';
	...
	$('#ps-filter').formValidation({
    	...
    	fields : {
            ...
            "history_filter[ps_school_year_id]": {
                validators: {
                    notEmpty: {
