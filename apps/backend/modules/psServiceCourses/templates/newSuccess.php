	...
	<div class="row">
      ...
      <div class="jarviswidget" id="wid-id-0"
				...
				<header>
					...
					<h2><?php echo __('New service courses', array(), 'messages') ?></h2>
...
$index ++;
          ...
          <?php include_partial('psServiceCourses/form', array('ps_service_courses' => $ps_service_courses, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper, 'list_student' => $list_student)) ?>
        </div>
