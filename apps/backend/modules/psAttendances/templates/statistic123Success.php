...
<!-- Không có quyền sửa điểm danh trên màn hình thống kê -->
		...
		style="max-height: 500px; width: 100%; overflow-y: scroll; overflow-x: scroll;">
		<table id="dt_basic" class="table table-striped table-bordered table-hover no-footer no-padding dataTable">
        <?php $sunday = PsDateTime::psSundaysOfMonth($year_month);?>
		<?php $saturday = PsDateTime::psSaturdaysOfMonth($year_month);?>
		<thead>
			<tr>
                ...
                <?php } ?>
                <th class="border_solid text-center goschool1"><?php echo __('Permission', array(), 'messages') ?></th>
					<th class="border_solid text-center"><?php echo __('Not Permission', array(), 'messages') ?></th>
					<th class="border_solid text-center"><?php echo __('Go school', array(), 'messages') ?></th>
					<th class="border_solid text-center"><?php echo __('Ratio', array(), 'messages') ?></th>
				</tr>
			</thead>
			<tbody>
				...
				<tr>
											...
											<td class=""><?php echo $list_student->getFullName() ?>
					<br />
											<code><?php echo $list_student->getStudentCode() ?></code></td>
                      <?php for ($i =1 ;$i <= $number_day['number_day_month']; $i++ ){ ?>
                      <?php if(date("Ymd", strtotime($i.'-'.$year_month)) <= date("Ymd")){?>
...
?>
                    ...
                    <?php } ?>
                    <td class="text-center last-child"></td>
					<td class="text-center last-child"></td>
					<td class="text-center last-child"></td>
					<td class="text-center last-child"></td>
				</tr>
	...
	<div class="custom-scroll table-responsive"
		...
		<thead>
			<tr>
				<th></th>
				<th><?php echo __('Student name', array(), 'messages') ?>
				</th>
                <?php for ($k =1 ;$k <= $number_day['number_day_month']; $k++ ){ ?>
                <th class="border_solid text-center <?php if(in_array($k, $sunday)){ echo 'bg-color-red';} if(in_array($k, $saturday)){ echo 'bg-color-orange'; }?>"><?php echo $k ?>
                </th>
                <?php } ?>
                <th class="border_solid text-center"><?php echo __('Permission', array(), 'messages') ?>
                </th>
				<th class="border_solid text-center"><?php echo __('Not Permission', array(), 'messages') ?>
				</th>
				<th class="border_solid text-center"><?php echo __('Go school', array(), 'messages') ?>
				</th>
				<th class="border_solid text-center"><?php echo __('Ratio', array(), 'messages') ?>
				</th>
			</tr>
		</thead>
		<tbody>
...
$log_value = '';
                      ...
                      <td class="text-center"><?php echo PreNumber::number_format ($h,1); $h='';?></td>
