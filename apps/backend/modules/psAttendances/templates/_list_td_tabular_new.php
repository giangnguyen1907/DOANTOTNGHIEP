...
<td class="sf_admin_text sf_admin_list_td_attendance text-center"><label
	class="radio no-margin no-padding "> <input
		...
		class="radiobox style-0" type="radio"
...
<td class="sf_admin_foreignkey sf_admin_list_td_service">
  <?php echo get_partial('psAttendances/td_service_of_student', array('type' => 'list', 'ps_attendances' => $ps_attendances,'tracked_at' => $tracked_at, 'list_service' => $list_service,'array_dichvu'=>$array_dichvu))?>
</td>
