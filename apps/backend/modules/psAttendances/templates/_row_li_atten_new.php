...
if ($list_student->getId ()) {
	if ($list_student->getLogValue () == 1) {
		...
		$border_color = 'border:2px solid #659265;display:inline-table;';
	} elseif ($list_student->getLogValue () == 2) {
		// $bg_color = 'background-color:#b09b5b!important';
		$border_color = 'border:2px solid #a90329;display:inline-table;';
	} else {
		// $bg_color = 'background-color: cadetblue';
		$border_color = 'border:2px solid #c79121;display:inline-table;';
	}
}
?>
<div style="<?php echo $border_color;?>">
