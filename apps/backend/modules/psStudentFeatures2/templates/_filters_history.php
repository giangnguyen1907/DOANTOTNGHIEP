<div id="dt_basic_filter" class="sf_admin_filter dataTables_filter">
	...
	<form id="ps-filter" class="form-inline pull-left"
		action="<?php echo url_for('ps_student_features_collection', array('action' => 'history')) ?>"
		method="post">
		<input type="hidden" name="ps_student_features_history_url"
			value="ps_student_features_history"
			id="ps_student_features_history_url">
		<div class="pull-left">
