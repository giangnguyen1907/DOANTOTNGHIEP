...
$(document).ready(function() {
	...
	$('#import_filter_ps_customer_id').change(function() {
		...
		resetOptions('import_filter_class_id');
...
$('#import_filter_ps_school_year_id').change(function() {
	...
	if ($('#import_filter_class_id').val() <= 0) {
		return;
	}
	$("#import_filter_class_id").attr('disabled', 'disabled');
	$.ajax({
...
<section id="widget-grid">
	<div class="row">
		<?php include_partial('psFeeReceipt/flashes2')?>
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="jarviswidget" id="wid-id-0"
				...
				<header>
					...
					<h2><?php echo __('Fee receipt import', array(), 'messages') ?></h2>
					<div class="widget-toolbar">
						<a class="btn btn-success" target="_blank"
							href="<?php echo url_for('@ps_fee_receipt_student_export') ?>"><i
				...
				<div id="sf_admin_content">
					...
					<div class="sf_admin_form widget-body">
					    ...
					    <?php endif; ?>
							...
							action="<?php echo url_for('@ps_fee_receipt_import_save') ?>"
							...
							<fieldset>
					    		...
					    		<?php if ($sf_user->hasCredential(array('PS_FEE_RECEIPT_NOTICATION_FILTER_SCHOOL'))): ?>
					    		<div class='col-md-6'>
									<div class="sf_admin_form_row sf_admin_foreignkey"
										style="margin-top: 25px">
										<label class="col-md-3 control-label">
							...
							<div class="form-actions">
								<div class="sf_admin_actions">
									<a
										...
										href="<?php echo url_for('@ps_fee_receipt') ?>"><i
