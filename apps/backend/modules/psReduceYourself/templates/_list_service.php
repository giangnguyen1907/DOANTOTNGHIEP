  ...
  <?php
    ...
    ?>
      <li class="select2" style="min-width:400px; padding-bottom: 10px;">
        ...
        <input placeholder="Nhập số tiền (hoặc %)" class="item_number_hssv" style="min-width:250px;" name="ps_reduce_yourself[json_service][<?php echo $list->getId() ?>]" type="number" id="input_service_<?php echo $list->getId() ?>" value="<?php echo $array_ser[$list->getId()] ? $array_ser[$list->getId()] : '' ?>" <?php echo $disabled; ?> >&nbsp;
