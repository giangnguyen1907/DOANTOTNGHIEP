		...
		<!-- sf_admin_container -->
			<div class="jarviswidget" id="wid-id-0"
				...
				<div>
					...
					<form id="frm_batch"
								action="<?php echo url_for('ps_receipt_temporary_collection', array('action' => 'batch')) ?>"
								method="post">
					
					<?php include_partial('psReceiptTemporary/list', array('pager' => $pager, 'sort' => $sort, 'helper' => $helper)) ?>
					...
					<!-- sf_admin_footer -->
				    	...
				    	<?php if ($pager->haveToPaginate()): ?>
      					<?php include_partial('psReceiptTemporary/pagination', array('pager' => $pager)) ?>
    					<?php endif; ?>
				    	</div>

									<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 text-right">
					      <?php include_partial('psReceiptTemporary/list_batch_actions', array('helper' => $helper)) ?>					      
				      </div>
								</div>
								<!-- END: sf_admin_footer -->
							</form>
