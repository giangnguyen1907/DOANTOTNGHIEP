		...
		<ul class="dropdown-menu dropdown-menu-sm pull-right">
			...
			<li><a href="javascript:void(0);" id="btn-export-student-payment"
				class="btn-export-student-payment"> <i
					class="fa-fw fa fa-cloud-download txt-color-greenLight"
					data-class=""></i>
			...
			<li><a href="javascript:void(0);"
				id="btn-export-student-balance-month"
			...
			<li><a href="javascript:void(0);"
				id="btn-export-fee-receipt-workplace"
			...
			<li><a href="javascript:void(0);"
				id="btn-export-fee-report-workplace"
			...
			<li><a href="javascript:void(0);"
				id="btn-print-fee-receipt-workplace"
