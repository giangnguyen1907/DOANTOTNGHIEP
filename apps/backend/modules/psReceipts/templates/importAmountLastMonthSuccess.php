		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget" id="wid-id-0"
				...
				<header>
					...
					<h2><?php echo __('Import balance last month amount', array(), 'messages') ?></h2>
					<div class="widget-toolbar">
					<?php if ($sf_user->hasCredential(array('PS_FEE_REPORT_IMPORT'))): ?>
						<a class="btn btn-success" href="<?php echo url_for('@ps_receipts_export_amount_last_month') ?>">
							<i class="fa fa-cloud-download"></i>Tải biểu mẫu
						</a>
					<?php endif?>
					</div>
				</header>
				<div>
				    ...
				    <?php endif; ?>
						<form id="ps-form" class="form-horizontal fv-form fv-form-bootstrap"
							action="<?php echo url_for('@ps_receipts_import_amount_last_month') ?>"
							method="post" enctype="multipart/form-data">
							<div class="sf_fieldset_none">
					    	 	<?php echo $formFilter->renderHiddenFields(true) ?>
					    	 	
					    	 	<?php if (myUser::credentialPsCustomers ( 'PS_FEE_REPORT_FILTER_SCHOOL' )) {?>
								...
								<div class='col-md-3 col-xs-12 col-sm-3'>
									<div class="sf_admin_form_row sf_admin_foreignkey" style="margin-top: 25px">
										<button type="submit" class="btn btn-default btn-success btn-sm btn-attendance">
											<i class="fa-fw fa fa-cloud-upload" aria-hidden="true" title="<?php echo __('Upload');?>"></i>
											<?php echo __('Upload', array(), 'messages') ?>
				                    	</button>
									</div>
								</div>
								</div>
