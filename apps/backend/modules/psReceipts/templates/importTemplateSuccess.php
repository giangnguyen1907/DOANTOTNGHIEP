		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget" id="wid-id-0"
				...
				<header>
					...
					<h2><?php echo __('Import register service', array(), 'messages') ?></h2>
					<div class="widget-toolbar">
					<?php if ($sf_user->hasCredential(array('PS_FEE_REPORT_IMPORT'))): ?>
						<a class="btn btn-success" href="<?php echo url_for('@export_template_receipt') ?>">
				...
				<div>
				    ...
				    <?php endif; ?>
						<form id="ps-form" class="form-horizontal fv-form fv-form-bootstrap"
							action="<?php echo url_for('@import_template_receipt') ?>"
