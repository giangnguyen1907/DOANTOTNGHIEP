...
<?php }?>
	<label> <strong>
		...
		$totalPayment = $receipt->getBalanceAmount() + $priceLatePayment;
		$totalPayment2 = $receipt->getBalanceAmount() + $receipt->getCollectedAmount() - $receipt->getChietkhau() + $priceLatePayment;
