<?php if ($field->isPartial()): ?>
  <?php include_partial('psAlbums/'.$name, array('form' => $form, 'attributes' => $attributes instanceof sfOutputEscaper ? $attributes->getRawValue() : $attributes)) ?>
<?php elseif ($field->isComponent()): ?>
  <?php include_component('psAlbums', $name, array('form' => $form, 'attributes' => $attributes instanceof sfOutputEscaper ? $attributes->getRawValue() : $attributes)) ?>
<?php else: ?>
...
<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
  ...
  <div class="form-group <?php echo $class ?> <?php $form[$name]->hasError() and print 'has-error' ?>">
	...
	<?php endif; ?>
	<span id='<?php echo $remaining ?>' class="note pull-right"></span>
	</div>
  </div>
 </div>
<?php endif; ?>
