<td class="text-center hidden-md hidden-sm hidden-xs">
	<div class="btn-group">
		...
		<?php echo $helper->linkToEdit($sf_guard_group, array(  'credentials' =>   array(0 => array(0 => 'PS_SYSTEM_GROUP_USER_EDIT_DETAIL', 1 => 'PS_SYSTEM_GROUP_USER_DELETE')),  'params' =>   array(  ),  'class_suffix' => 'edit',  'label' => 'Edit',)) ?>
