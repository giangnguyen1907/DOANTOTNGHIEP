		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="jarviswidget" id="wid-id-0"
				...
				<header>
					...
					<h2><?php echo __('Imports menus', array(), 'messages') ?></h2>

					<div class="widget-toolbar">
						<a class="btn btn-success" target="_blank"
							href="<?php echo url_for('@ps_menus_export') ?>"><i
				...
				<div id="sf_admin_content">
					...
					<div class="sf_admin_form widget-body">
					    ...
					    <?php endif; ?>
							...
							action="<?php echo url_for('@ps_menus_import_save') ?>"
							method="post" enctype="multipart/form-data">
							<fieldset>
					    	 	<?php echo $formFilter->renderHiddenFields(true) ?>
					    	 	
                        		<?php if ($sf_user->hasCredential(array('PS_NUTRITION_MENUS_FILTER_SCHOOL'))): ?>
                        		<div class='col-md-6'>
								...
								<div class='col-md-6'>
									<div class="sf_admin_form_row sf_admin_foreignkey"
										style="margin-top: 25px">
										<label class="col-md-3 control-label">
                                		 	<?php echo __('Select object group', array(), 'messages') ?>
							...
							<div class="form-actions">
								<div class="sf_admin_actions">
									<a
										...
										href="<?php echo url_for('@ps_menus_imports') ?>"><i
