...
<span id="batch-actions">
  ...
  <?php if ($sf_user->hasCredential('PS_HR_CERTIFICATE_EDIT')): ?>
<button type="button" id="batch_action_batchUpdateOrder"
		...
		<i class="fa-fw fa fa-floppy-o" aria-hidden="true" title="Lưu lại"></i> <?php echo __('Update', array(), 'sf_admin') ?></button>
<?php endif; ?>
  <?php if ($sf_user->hasCredential('PS_HR_CERTIFICATE_DELETE')): ?>
