	...
	<div class="row">
      ...
      <div class="jarviswidget" id="wid-id-0"
				...
				<header>
					...
					<h2><?php echo __('New PsStudents', array(), 'messages') ?></h2>
...
$index = 1;
          ...
          <?php include_partial('psStudents/form', array('student' => $student, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
        </div>
