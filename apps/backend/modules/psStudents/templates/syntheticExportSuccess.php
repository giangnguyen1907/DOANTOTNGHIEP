...
var msg_select_class_id		    = '<?php echo __('Please select class filter the data.')?>';
var msg_select_ps_schoolyear_id	= '<?php echo __('Please select school year to filter the data.')?>';
var msg_select_type_export      = '<?php echo __('Please select type export to filter the data.')?>';
...
$('#ps-filter').formValidation({
	...
	fields : {
        ...
        "export_filter[type_export]": {
            validators: {
                notEmpty: {
                    message: {vi_VN: msg_select_type_export,
                    		  en_US: msg_select_type_export
                    }
                }
            }
        },
...
<section id="widget-grid">
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget" id="wid-id-0"
				...
				<header>
					...
					<h2><?php echo __('Student synthetic export', array(), 'messages') ?></h2>
    ...
    <?php endif; ?>
		<form id="ps-filter" class="form-inline pull-left"
								action="<?php echo url_for('ps_students_collection', array('action' => 'syntheticExport')) ?>"
								method="post">
								<div class="pull-left">
    	 	...
    	 	<div class="form-group">
        		 	...
        		 	<?php echo $formFilter['class_id']->renderError() ?>
									...
									<div class="form-group">
										<label>
        		 	<?php echo $formFilter['type_export']->render() ?>
        		 	<?php echo $formFilter['type_export']->renderError() ?>
        		 </label>
									</div>
									<div class="form-group">
										<label>
											<button type="submit" rel="tooltip" data-placement="bottom"
												...
												<i class="fa-fw fa fa-cloud-download"></i> <?php echo __('Export file')?>
                    						</button>
										</label>
									</div>
