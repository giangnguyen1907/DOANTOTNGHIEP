<td class="sf_admin_text sf_admin_list_td_is_update_by">
  ...
  <?php //echo 'AAA_'.$filter_value['type']; ?>
</td>
<td class="sf_admin_text sf_admin_list_td_title" style="width: 300px;">
	<a data-backdrop="static" data-toggle="modal"
	data-target="#remoteModal"
	href="<?php echo url_for('@ps_cms_notification_detail?id='.$ps_cms_notifications->getId())?>">
...
<td class="sf_admin_text sf_admin_list_td_list_received"
	style="width: 300px;">
  <?php echo get_partial('psCmsNotification/list_received', array('type' => 'list', 'ps_cms_notifications' => $ps_cms_notifications)) ?>
</td>
