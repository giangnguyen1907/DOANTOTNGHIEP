...
<ul class="inbox-menu-lg">
	<li <?php if($type == 'new'): ?> class="active" <?php endif;?>><a
		href="<?php echo url_for('ps_cms_notifications_ps_cms_notification_new') ?>"><i
			class="fa fa-plus" aria-hidden="true"></i> <?php echo __('New')?></a></li>
	<li <?php if($type == 'received'): ?> class="active" <?php endif;?>><a
		href="<?php echo url_for('@ps_cms_notifications_ps_cms_notification?type=received') ?>"
	...
	<li <?php if($type == 'sent'): ?> class="active" <?php endif;?>><a
		href="<?php echo url_for('@ps_cms_notifications_ps_cms_notification?type=sent') ?>"
		class="row-id"><i class="fa fa-send-o" aria-hidden="true"></i> <?php echo __('Sent')?></a></li>
	<!-- 
	<li <?php if($type == 'drafts'): ?> class="active" <?php endif;?>><a
		href="<?php echo url_for('@ps_cms_notifications_ps_cms_notification?type=drafts') ?>" class="row-id"><i class="fa fa-edit "
			aria-hidden="true"></i> <?php echo __('Draft')?></a></li>
	 -->
	<li <?php if($type == 'trash'): ?> class="active" <?php endif;?>><a
		href="<?php echo url_for('@ps_cms_notifications_ps_cms_notification?type=trash') ?>"
