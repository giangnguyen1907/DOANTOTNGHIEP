...
<div class="col-md-12 pull-left">
	...
	<div class="col-md-4 pull-left text-center border-left">
		<?php if ($sf_user->hasCredential(array('PS_STUDENT_SUBJECT_EDIT', 'PS_STUDENT_SUBJECT_ADD'), false) && $service->getEnableRoll() == PreSchool::SERVICE_TYPE_NOT_FIXED):?>
		<?php echo link_to(__('Split'),'@ps_subject_splits_new?sid='.$service->getId(), array('class' => 'btn btn-xs btn-default btn-success btn-psadmin'))?>
		<?php endif;?>
	</div>
</div>