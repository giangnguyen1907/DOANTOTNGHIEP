<div class="sf_admin_pagination">
	<a href="<?php echo url_for('@ps_app_permission') ?>?page=1">
    <?php echo image_tag(sfConfig::get('sf_admin_module_web_dir').'/images/first.png', array('alt' => __('First page', array(), 'sf_admin'), 'title' => __('First page', array(), 'sf_admin'))) ?>
		...
		href="<?php echo url_for('@ps_app_permission') ?>?page=<?php echo $pager->getPreviousPage() ?>">
  ...
  <?php foreach ($pager->getLinks() as $page): ?>
    ...
    <?php else: ?>
      <a
		href="<?php echo url_for('@ps_app_permission') ?>?page=<?php echo $page ?>"><?php echo $page ?></a>
    <?php endif; ?>
  <?php endforeach; ?>

  <a
		href="<?php echo url_for('@ps_app_permission') ?>?page=<?php echo $pager->getNextPage() ?>">
    <?php echo image_tag(sfConfig::get('sf_admin_module_web_dir').'/images/next.png', array('alt' => __('Next page', array(), 'sf_admin'), 'title' => __('Next page', array(), 'sf_admin'))) ?>
		...
		href="<?php echo url_for('@ps_app_permission') ?>?page=<?php echo $pager->getLastPage() ?>">
