...
<section id="widget-grid">
	<div class="row">
		<?php include_partial('psRelationship/flashes_students_import')?>
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="jarviswidget" id="wid-id-0"
				...
				<header>
					...
					<h2><?php echo __('Import student and relative', array(), 'messages') ?></h2>
					<?php $path_file1 = '/media-template/import/BM01_ImportStudent.xlsx'; ?>
					<?php $path_file2 = '/media-template/import/BM02_ImportStudent.xlsx'; ?>
					<div class="widget-toolbar">
						<a class="btn btn-xs btn-success" href="<?php echo $path_file1?>"><i
				...
				<div id="sf_admin_content">
					...
					<div class="sf_admin_form widget-body">
					    ...
					    <?php endif; ?>
							...
							action="<?php echo url_for('@ps_students_relationship_import_save') ?>"
							...
							<fieldset>
								...
								<div class='col-md-6'>
									<div class="sf_admin_form_row sf_admin_foreignkey"
										style="margin-top: 25px">
										<label class="col-md-3 control-label">
						    		 		<?php echo __('Select template', array(), 'messages') ?>
						    		  	</label>
										<div class="col-md-9">
						        		 	<?php echo $formFilter['ps_template']->render() ?>
						        		 	<?php echo $formFilter['ps_template']->renderError() ?>
						        		 </div>
									</div>
								</div>
