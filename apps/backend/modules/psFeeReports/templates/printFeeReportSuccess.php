...
<link rel="stylesheet" type="text/css" media="screen"
	href="/web/psAdminThemePlugin/css/bootstrap.min.css" />
...
<?php
$file_template_file = $ps_workplace->getConfigTemplateReportExport ();

if ($file_template_file == 'bm_phieubao_01.xls') { // xuất theo biểu mẫu 1 ?>
			...
			<div class="modal-body">
					...
					<div class="col-md-3 col-sm-3 col-xs-3">
						<div class="logo">
							<img alt="<?php echo $ps_customer->getTitle();?>"
								...
								src="<?php echo '/media-web/'.$ps_customer->getYearData().'/logo/'.$ps_customer->getLogo();?>">
						</div>
					</div>
				...
				<div class="row">
					<div class="tieudephieu">
						<h5>
							<b><?php echo __ ( 'Notice of tuition fees' ) . ' ' . date ( "m-Y", strtotime($receipt->getReceiptDate ()) )?></b>
						</h5>
					</div>
					<div class="col-md-6 col-xs-6 col-sm-6">
...
<?php }elseif($file_template_file == 'bm_phieubao_02.xls'){ // xuất theo biểu mẫu 2 ?>
...
<?php }elseif($file_template_file == 'bm_phieubao_03.xls'){ // // xuất theo biểu mẫu 3 ?>
