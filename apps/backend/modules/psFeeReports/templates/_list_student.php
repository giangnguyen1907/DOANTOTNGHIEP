...
<tr>
	...
	<td>
	<?php echo $student->getFirstName().' '.$student->getLastName();?><br />
		<code><?php echo $student->getStudentCode();?></code>
	</td>
	<td>
		<?php echo get_partial('psFeeReports/birthday', array('type' => 'list', 'ps_fee_reports' => $student)) ?>
	</td>
	<td class="text-center">
		<div class="btn-group">
			<a class="btn btn-xs btn-default" data-backdrop="static"
				...
				href="<?php echo url_for('@ps_fee_reports_receivable_student_detail?sid='.$student->getId().'&kstime='.$ktime)?>"><i
