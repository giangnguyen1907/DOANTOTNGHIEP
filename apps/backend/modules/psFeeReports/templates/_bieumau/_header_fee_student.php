<div class="row">
	<div class="col-md-3 col-sm-3 col-xs-3">
		<div class="logo">
			<img alt="<?php echo $psClass->getCusTitle();?>"
				style="text-align: center; max-width: 90px; max-height: 90px;position: absolute;"
				src="<?php echo '/media-web/'.$psClass->getYearData().'/logo/'.$psClass->getLogo();?>">
		</div>
	</div>
	<div class="col-md-9 col-sm-9 col-xs-9">
		<div class="thongtintruong" style="padding-top: 10px">
			<p><?php echo $psClass->getCusTitle();?></p>
...
<div class="row">
	...
	<div class="col-md-6 col-xs-6 col-sm-6">
		<strong><?php echo __('Class').': '?></strong><?php echo $psClass->getClName();?>
	</div>
	<div class="col-md-6 col-xs-6 col-sm-6">
		<strong></strong>
	</div>
