      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table table-bordered no-footer no-padding" id="dt_basic">
		...
		?>
          <tr>
            ...
            <td class="text-center" style="width: 35mm;"><b><?php echo __('Name fees');?></b></td>
            ...
            <td class="text-center" style="width: 25mm;"><b><?php echo __('Giam tru');?></b></td>
      ...
      <div class="row" style="margin-top:30px;">
	    <div class="col-md-4 col-xs-4 col-sm-4">
	        <div class="text-center">
	          <?php echo $receipt->getPaymentRelativeName()?>
	        </div>
      	</div>      	
      	<div class="col-md-4 col-xs-4 col-sm-4">
	        <div class="text-center">
