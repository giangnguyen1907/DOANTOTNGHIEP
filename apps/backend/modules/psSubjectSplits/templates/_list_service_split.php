<div class="table-responsive">
	<table id="dt_basic"
		...
		<thead>
			<tr>
				<th class="text-center w-20" style="width: 20%;"><?php echo __('Count value')?></th>
				<th class="text-center w-20" style="width: 20%;"><?php echo __('Count ceil')?></th>
				...
				<th data-hide="phone,tablet" id="sf_admin_list_th_actions"
					class="text-center w-10" style="width: 10%;"><?php echo __('Actions', array(), 'sf_admin') ?></th>
			</tr>
		</thead>
		<tbody>
		...
		<tr
				...
				<td class="text-center"><?php echo PreSchool::format_number($ps_service_split->getSplitValue())?></td>
				<td class="text-right">
			<?php
			if ($service_detail) {
