...
<div class="modal-header">
	...
	<h4 class="modal-title" id="myModalLabel"><?php echo __('List student weight '.$index) ?></h4>
</div>
<div class="modal-body">
	<div class="row">
		<div class="tab-content">
            ...
            <?php //echo $growths; ?>
            <tbody>
              <?php foreach ($growths_weight as $ps_student_growths): ?>
                <tr>
...
<div class="modal-footer">
	<a class="btn btn-default"
		href="<?php echo url_for(@ps_student_growths).'/'.$examination->getId().'/'.$class_name->getId().'/'.$growths.'/'; ?>export_weight"><i
