...
?>
<div class="modal fade" id="confirmDeleteEvaluateClass" role="dialog"
	aria-labelledby="myModalLabel" aria-hidden="true">
	<form class="form-horizontal" id="ps-form-delete-evaluate-class"
	...
	<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p><?php echo __("Are you sure you want to remove this?")?></p>
				</div>
