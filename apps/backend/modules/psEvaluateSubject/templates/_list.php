...
<th class="sf_admin_text sf_admin_list_th_subject_code" <?php echo $style_order; ?>>
 <?php echo __('Subject code', array(), 'messages')?>
  <div> <?php if ('subject_code' == $sort[0]): ?>
    <?php echo link_to(__('Subject code', array(), 'messages'), '@ps_evaluate_subject', array('query_string' => 'sort=subject_code&sort_type='.($sort[1] == 'asc' ? 'desc' : 'asc'))) ?>
    <?php echo '<i class="fa fa-chevron-'.($sort[1] == 'asc' ? 'down' : 'up').' txt-color-greenDark" aria-hidden="true"></i>' ?>
	
  <?php else: ?>
    <?php echo link_to(__('Subject code', array(), 'messages'), '@ps_evaluate_subject', array('query_string' => 'sort=subject_code&sort_type=asc')) ?>
  <?php endif; ?></div>
</th>
<?php end_slot(); ?>
<?php include_slot('sf_admin.current_header') ?><?php slot('sf_admin.current_header') ?>
...
<th class="sf_admin_text sf_admin_list_th_title" <?php echo $style_order; ?>>
  ...
  <div><?php if ('title' == $sort[0]): ?>
    <?php echo link_to(__('Title', array(), 'messages'), '@ps_evaluate_subject', array('query_string' => 'sort=title&sort_type='.($sort[1] == 'asc' ? 'desc' : 'asc'))) ?>
    <?php echo '<i class="fa fa-chevron-'.($sort[1] == 'asc' ? 'down' : 'up').' txt-color-greenDark" aria-hidden="true"></i>' ?>
	
  <?php else: ?>
    <?php echo link_to(__('Title', array(), 'messages'), '@ps_evaluate_subject', array('query_string' => 'sort=title&sort_type=asc')) ?>
  <?php endif; ?></div>
</th>
<?php end_slot(); ?>
<?php include_slot('sf_admin.current_header') ?><?php slot('sf_admin.current_header') ?>
...
<th class="sf_admin_boolean sf_admin_list_th_is_activated" <?php echo $style_order; ?>>
 <?php echo __('Is activated', array(), 'messages')?>
  <div> <?php if ('is_activated' == $sort[0]): ?>
    <?php echo link_to(__('Is activated', array(), 'messages'), '@ps_evaluate_subject', array('query_string' => 'sort=is_activated&sort_type='.($sort[1] == 'asc' ? 'desc' : 'asc'))) ?>
    <?php echo '<i class="fa fa-chevron-'.($sort[1] == 'asc' ? 'down' : 'up').' txt-color-greenDark" aria-hidden="true"></i>' ?>
	
  <?php else: ?>
    <?php echo link_to(__('Is activated', array(), 'messages'), '@ps_evaluate_subject', array('query_string' => 'sort=is_activated&sort_type=asc')) ?>
  <?php endif; ?></div>
</th>
<?php end_slot(); ?>
<?php include_slot('sf_admin.current_header') ?><?php slot('sf_admin.current_header') ?>
...
<?php include_slot('sf_admin.current_header') ?>
	        ...
	        <tr class="hidden-lg hidden-md">
	          <?php include_partial('psEvaluateSubject/list_th_tabular', array('sort' => $sort)) ?>
      ...
      <tbody>
        <?php foreach ($pager->getResults() as $i => $ps_evaluate_subject): $odd = fmod(++$i, 2) ? 'odd' : 'even' ?>
          <tr class="sf_admin_row <?php echo $odd ?>">
			
			            <?php include_partial('psEvaluateSubject/list_td_tabular', array('ps_evaluate_subject' => $ps_evaluate_subject)) ?>
						            <?php include_partial('psEvaluateSubject/list_td_actions', array('ps_evaluate_subject' => $ps_evaluate_subject, 'helper' => $helper)) ?>
			                        <?php include_partial('psEvaluateSubject/list_td_batch_actions', array('ps_evaluate_subject' => $ps_evaluate_subject, 'helper' => $helper)) ?>
                </tr>
        <?php endforeach; ?>
      </tbody>
    </table>
