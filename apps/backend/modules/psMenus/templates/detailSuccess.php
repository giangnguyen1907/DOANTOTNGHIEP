	...
	<div class="row">
      ...
      <div class="jarviswidget" id="wid-id-0"
				...
				<div id="sf_admin_content">
			        ...
			        <?php include_partial('psMenus/week_menu_detail', array('list_meal' => $list_meal, 'list_menu'=>$list_menu, 'week_list' => $week_list, 'width_th' => (100 / (count($week_list) + 1)),'formFilter' => $formFilter, 'form' => $form, 'ps_menus' => $ps_menus));?>
