			...
			<div class="jarviswidget" id="wid-id-0"
				...
				<div>
					...
					<?php if(count($students) > 0 ):?>
						...
						<?php include_partial('psEvaluateIndexStudent/evaluate_content', array('pager' => $pager, 'sort' => $sort, 'helper' => $helper,'students' =>$students, 'students_evaluate' => $students_evaluate, 'evaluate' => $evaluate, 'symbols' => $symbols, 'filterValue' => $filterValue, 'schoolyear' => $schoolyear)) ?>
