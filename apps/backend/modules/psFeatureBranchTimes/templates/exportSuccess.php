...
<section id="widget-grid">
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget" id="wid-id-0"
				...
				<header>
					...
					<h2><?php echo __('Ps feature branch export template 2', array(), 'messages') ?></h2>
				</header>
				<div>
    ...
    <?php endif; ?>
		<form id="ps-filter" class="form-inline pull-left"
								action="<?php echo url_for('ps_feature_branch_times_collection', array('action' => 'export')) ?>"
								method="post">
								<div class="pull-left">
        		 	...
        		 	<?php echo $formFilter['ps_month']->renderError() ?>
									...
									<div class="form-group">
										<label>
						        		 	...
						        		 	<?php echo $formFilter['from_date']->renderError() ?>
						        		 </label>
									</div>
									<div class="form-group">
										<label>
						        		 	<?php echo $formFilter['to_date']->render() ?>
						        		 	<?php echo $formFilter['to_date']->renderError() ?>
						        		 </label>
									</div>
