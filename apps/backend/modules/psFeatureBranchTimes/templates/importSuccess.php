		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="jarviswidget" id="wid-id-0"
				...
				<header>
					...
					<h2><?php echo __('Import feature branch times template 2', array(), 'messages') ?></h2>
					
					<div class="widget-toolbar">
						<a class="btn btn-xs btn-success" target="_blank" href="<?php echo url_for('@ps_feature_branch_times_export') ?>"><i
				...
				<div id="sf_admin_content">
					...
					<div class="sf_admin_form widget-body">
					    ...
					    <?php endif; ?>
							...
							action="<?php echo url_for('@ps_feature_branch_times_import_save') ?>"
							...
							<fieldset>
								...
								<?php if ($sf_user->hasCredential('PS_SYSTEM_FEATURE_BRANCH_FILTER_SCHOOL')){ ?>
								<div class='col-md-6'>
									<div class="sf_admin_form_row sf_admin_foreignkey"
										style="margin-top: 25px">
										<label class="col-md-3 control-label">
