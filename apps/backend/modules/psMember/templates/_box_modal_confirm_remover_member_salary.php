...
?>
<div class="modal fade" id="confirmDeleteMemberSalary" role="dialog"
	aria-labelledby="myModalLabel" aria-hidden="true">
	<form class="form-horizontal" id="ps-form-delete-member-salary"
	...
	<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p><?php echo __("Are you sure you want to remove this member salary?")?></p>
				</div>
