...
?>
<div class="modal fade" id="confirmDeleteMemberAllowance" role="dialog"
	aria-labelledby="myModalLabel" aria-hidden="true">
	<form class="form-horizontal" id="ps-form-delete-member-allowance"
	...
	<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p><?php echo __("Are you sure you want to remove this member allowance?")?></p>
				</div>
