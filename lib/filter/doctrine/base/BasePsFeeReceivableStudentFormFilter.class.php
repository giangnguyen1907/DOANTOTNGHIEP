...
/**
 * PsFeeReceivableStudent filter form base class.
 *
 ...
 */
abstract class BasePsFeeReceivableStudentFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'ps_fee_receipt_id' => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      'ps_fee_receipt_id' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('ps_fee_receivable_student_filters[%s]');
