...
/**
 * PsProvince filter form base class.
 *
 ...
 */
abstract class BasePsProvinceFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ps_province_filters[%s]');
