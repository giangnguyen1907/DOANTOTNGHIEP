...
/**
 * PsReviewRelative filter form base class.
 *
 ...
 */
abstract class BasePsReviewRelativeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'category_review_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('PsCategoryReview'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('ps_review_relative_filters[%s]');
