...
/**
 * PsTypeAge filter form base class.
 *
 ...
 */
abstract class BasePsTypeAgeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'start_month'     => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      ...
      'stop_month'      => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('ps_type_age_filters[%s]');
