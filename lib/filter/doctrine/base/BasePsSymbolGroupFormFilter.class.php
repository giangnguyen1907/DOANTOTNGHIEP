...
/**
 * PsSymbolGroup filter form base class.
 *
 ...
 */
abstract class BasePsSymbolGroupFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'group_symbol'    => new sfWidgetFormFilterInput(),
      'is_type'         => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'is_payment'      => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'group_symbol'    => new sfValidatorPass(array('required' => false)),
      'is_type'         => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'is_payment'      => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
    ...
    $this->widgetSchema->setNameFormat('ps_symbol_group_filters[%s]');
