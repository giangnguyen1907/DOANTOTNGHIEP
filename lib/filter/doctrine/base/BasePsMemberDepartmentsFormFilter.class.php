...
/**
 * PsMemberDepartments filter form base class.
 *
 ...
 */
abstract class BasePsMemberDepartmentsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'ps_department_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('PsDepartment'), 'column' => 'id')),
      ...
      'ps_function_id'   => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('PsFunction'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('ps_member_departments_filters[%s]');
