...
/**
 * PsAllowance filter form base class.
 *
 ...
 */
abstract class BasePsAllowanceFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'allowance_value' => new sfWidgetFormFilterInput(),
    ...
    $this->widgetSchema->setNameFormat('ps_allowance_filters[%s]');
