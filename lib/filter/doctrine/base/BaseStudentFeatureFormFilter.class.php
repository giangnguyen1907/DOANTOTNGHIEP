...
/**
 * StudentFeature filter form base class.
 *
 ...
 */
abstract class BaseStudentFeatureFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'feature_option_feature_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('FeatureOptionFeature'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('student_feature_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      ...
      'feature_option_feature_id' => 'ForeignKey',
      'tracked_at'                => 'Date',
      'note'                      => 'Text',
      'time_at'                   => 'Date',
