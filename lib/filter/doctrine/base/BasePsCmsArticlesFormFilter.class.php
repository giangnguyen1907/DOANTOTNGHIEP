...
/**
 * PsCmsArticles filter form base class.
 *
 ...
 */
abstract class BasePsCmsArticlesFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'is_publish'      => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'is_access'       => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'is_global'       => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'year_data'       => new sfWidgetFormFilterInput(),
      'user_publish_id' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'is_access'       => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      ...
      'user_publish_id' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('ps_cms_articles_filters[%s]');
