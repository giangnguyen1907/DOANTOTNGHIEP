...
/**
 * PsConfigLateFees filter form base class.
 *
 ...
 */
abstract class BasePsConfigLateFeesFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'from_minute'     => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'to_minute'       => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'from_minute'     => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'to_minute'       => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('ps_config_late_fees_filters[%s]');
