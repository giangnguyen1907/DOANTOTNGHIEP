...
/**
 * PsServiceSplit filter form base class.
 *
 ...
 */
abstract class BasePsServiceSplitFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ps_service_split_filters[%s]');
