...
/**
 * PsMemberAllowance filter form base class.
 *
 ...
 */
abstract class BasePsMemberAllowanceFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'ps_allowance_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('PsAllowance'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('ps_member_allowance_filters[%s]');
