...
/**
 * PsProfessional filter form base class.
 *
 ...
 */
abstract class BasePsProfessionalFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ps_professional_filters[%s]');
