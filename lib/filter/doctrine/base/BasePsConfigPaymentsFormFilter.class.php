...
/**
 * PsConfigPayments filter form base class.
 *
 ...
 */
abstract class BasePsConfigPaymentsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ps_config_payments_filters[%s]');
