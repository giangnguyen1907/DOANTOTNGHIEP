...
/**
 * PsFeatureBranchSynthetic filter form base class.
 *
 ...
 */
abstract class BasePsFeatureBranchSyntheticFormFilter extends BaseFormFilterDoctrine {
	...
	public function setup() {
		...
		$this->setWidgets ( array (
				...
				'feature_id' => new sfWidgetFormFilterInput (),
				'feature_sum' => new sfWidgetFormFilterInput (),
		...
		$this->setValidators ( array (
				...
				'ps_class_id' => new sfValidatorSchemaFilter ( 'text', new sfValidatorInteger ( array (
						'required' => false ) ) ),
				'feature_id' => new sfValidatorSchemaFilter ( 'text', new sfValidatorInteger ( array (
						'required' => false ) ) ),
				'feature_sum' => new sfValidatorSchemaFilter ( 'text', new sfValidatorInteger ( array (
						'required' => false ) ) ),
		...
		$this->widgetSchema->setNameFormat ( 'ps_feature_branch_synthetic_filters[%s]' );
