...
/**
 * StudentServiceDiary filter form base class.
 *
 ...
 */
abstract class BaseStudentServiceDiaryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('student_service_diary_filters[%s]');
