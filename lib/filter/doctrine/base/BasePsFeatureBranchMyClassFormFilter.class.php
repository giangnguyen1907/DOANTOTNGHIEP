...
/**
 * PsFeatureBranchMyClass filter form base class.
 *
 ...
 */
abstract class BasePsFeatureBranchMyClassFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ps_feature_branch_my_class_filters[%s]');
