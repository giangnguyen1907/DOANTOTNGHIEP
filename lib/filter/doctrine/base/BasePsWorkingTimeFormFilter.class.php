...
/**
 * PsWorkingTime filter form base class.
 *
 ...
 */
abstract class BasePsWorkingTimeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ps_working_time_filters[%s]');
