...
/**
 * PsSchoolYear filter form base class.
 *
 ...
 */
abstract class BasePsSchoolYearFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ps_school_year_filters[%s]');
