...
/**
 * PsObjectGroup filter form base class.
 *
 ...
 */
abstract class BasePsObjectGroupFormFilter extends BaseFormFilterDoctrine {

	public function setup() {

		$this->setWidgets ( array (
				'title' => new sfWidgetFormFilterInput ( array (
						'with_empty' => false ) ),
		...
		$this->setValidators ( array (
				'title' => new sfValidatorPass ( array (
						'required' => false ) ),
				'note' => new sfValidatorPass ( array (
						'required' => false ) ),
				'iorder' => new sfValidatorSchemaFilter ( 'text', new sfValidatorInteger ( array (
						'required' => false ) ) ),
		...
		$this->widgetSchema->setNameFormat ( 'ps_object_group_filters[%s]' );
