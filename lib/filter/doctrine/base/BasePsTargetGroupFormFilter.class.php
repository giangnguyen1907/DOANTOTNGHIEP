...
/**
 * PsTargetGroup filter form base class.
 *
 ...
 */
abstract class BasePsTargetGroupFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ps_target_group_filters[%s]');
