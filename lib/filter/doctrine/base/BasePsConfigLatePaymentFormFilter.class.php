...
/**
 * PsConfigLatePayment filter form base class.
 *
 ...
 */
abstract class BasePsConfigLatePaymentFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ps_config_late_payment_filters[%s]');
