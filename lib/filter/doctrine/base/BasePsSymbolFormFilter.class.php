...
/**
 * PsSymbol filter form base class.
 *
 ...
 */
abstract class BasePsSymbolFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ps_symbol_filters[%s]');
