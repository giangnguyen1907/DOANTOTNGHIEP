...
/**
 * PsImages filter form base class.
 *
 ...
 */
abstract class BasePsImagesFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'file_group'      => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'file_group'      => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ps_images_filters[%s]');
