...
/**
 * PsFeeReceipt filter form base class.
 *
 ...
 */
abstract class BasePsFeeReceiptFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'receivable_amount'      => new sfWidgetFormFilterInput(),
      ...
      'payment_relative'       => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'payment_relative'       => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ps_fee_receipt_filters[%s]');
