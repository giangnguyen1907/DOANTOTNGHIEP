...
/**
 * PsServiceCourses filter form base class.
 *
 ...
 */
abstract class BasePsServiceCoursesFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'ps_service_id'   => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('PsService'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      'ps_service_id'   => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('PsService'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('ps_service_courses_filters[%s]');
