...
/**
 * PsSemester filter form base class.
 *
 ...
 */
abstract class BasePsSemesterFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'semester_one'    => new sfWidgetFormFilterInput(),
      'semester_two'    => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'semester_one'    => new sfValidatorPass(array('required' => false)),
      'semester_two'    => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ps_semester_filters[%s]');
