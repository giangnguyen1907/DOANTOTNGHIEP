...
/**
 * FeatureOptionCourse filter form base class.
 *
 ...
 */
abstract class BaseFeatureOptionCourseFormFilter extends BaseFormFilterDoctrine {
	...
	public function setup() {
		...
		$this->setValidators ( array (
				'type' => new sfValidatorSchemaFilter ( 'text', new sfValidatorInteger ( array (
						'required' => false ) ) ),
				'order_by' => new sfValidatorSchemaFilter ( 'text', new sfValidatorInteger ( array (
						'required' => false ) ) ),
		...
		$this->widgetSchema->setNameFormat ( 'feature_option_course_filters[%s]' );
