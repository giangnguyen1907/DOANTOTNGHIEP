...
/**
 * PsEvaluateSubject filter form base class.
 *
 ...
 */
abstract class BasePsEvaluateSubjectFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'subject_code'    => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'subject_code'    => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ps_evaluate_subject_filters[%s]');
