...
/**
 * ObjectGroup filter form base class.
 *
 ...
 */
abstract class BaseObjectGroupFormFilter extends BaseFormFilterDoctrine {
	...
	public function setup() {
		...
		$this->widgetSchema->setNameFormat ( 'object_group_filters[%s]' );
