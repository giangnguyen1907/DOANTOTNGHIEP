...
/**
 * ReceivableDetail filter form base class.
 *
 ...
 */
abstract class BaseReceivableDetailFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('receivable_detail_filters[%s]');
