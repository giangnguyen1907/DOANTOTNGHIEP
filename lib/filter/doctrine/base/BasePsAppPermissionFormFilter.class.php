...
/**
 * PsAppPermission filter form base class.
 *
 ...
 */
abstract class BasePsAppPermissionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ps_app_permission_filters[%s]');
