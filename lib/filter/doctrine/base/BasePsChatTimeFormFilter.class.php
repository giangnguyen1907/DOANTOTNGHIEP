...
/**
 * PsChatTime filter form base class.
 *
 ...
 */
abstract class BasePsChatTimeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ps_chat_time_filters[%s]');
