...
/**
 * PsNotificationStudent filter form base class.
 *
 ...
 */
abstract class BasePsNotificationStudentFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'student_id'     => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('PsStudents'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'student_id'     => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('PsStudents'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('ps_notification_student_filters[%s]');
