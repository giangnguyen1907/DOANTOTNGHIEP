...
/**
 * Receivable form base class.
 *
 * @method Receivable getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseReceivableForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ps_school_year_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('PsSchoolYear'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'ps_school_year_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('PsSchoolYear'))),
    ...
    $this->widgetSchema->setNameFormat('receivable[%s]');
