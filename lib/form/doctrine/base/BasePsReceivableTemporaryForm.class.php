...
/**
 * PsReceivableTemporary form base class.
 *
 * @method PsReceivableTemporary getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasePsReceivableTemporaryForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ps_receivable_temporary[%s]');
