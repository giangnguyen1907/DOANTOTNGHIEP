...
/**
 * PsSemester form base class.
 *
 * @method PsSemester getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasePsSemesterForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'semester_one'    => new sfWidgetFormInputText(),
      'semester_two'    => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'semester_one'    => new sfValidatorString(array('max_length' => 50, 'required' => false)),
      'semester_two'    => new sfValidatorString(array('max_length' => 50, 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ps_semester[%s]');
