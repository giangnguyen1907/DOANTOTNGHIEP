...
/**
 * PsDepartment form base class.
 *
 * @method PsDepartment getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasePsDepartmentForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ps_department[%s]');
