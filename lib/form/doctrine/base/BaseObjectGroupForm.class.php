...
/**
 * ObjectGroup form base class.
 *
 * @method ObjectGroup getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseObjectGroupForm extends BaseFormDoctrine {
	...
	public function setup() {
		...
		$this->widgetSchema->setNameFormat ( 'object_group[%s]' );
