...
/**
 * PsReceiptTemporary form base class.
 *
 * @method PsReceiptTemporary getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasePsReceiptTemporaryForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ps_receipt_temporary[%s]');
