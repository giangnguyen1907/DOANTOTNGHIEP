...
/**
 * PsWorkingTime form base class.
 *
 * @method PsWorkingTime getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasePsWorkingTimeForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ps_working_time[%s]');
