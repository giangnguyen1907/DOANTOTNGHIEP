...
/**
 * PsCategoryReview form base class.
 *
 * @method PsCategoryReview getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasePsCategoryReviewForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ps_category_review[%s]');
