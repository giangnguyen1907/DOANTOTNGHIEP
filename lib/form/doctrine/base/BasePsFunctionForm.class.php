...
/**
 * PsFunction form base class.
 *
 * @method PsFunction getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasePsFunctionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ps_function[%s]');
