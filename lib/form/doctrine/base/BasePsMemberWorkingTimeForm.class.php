...
/**
 * PsMemberWorkingTime form base class.
 *
 * @method PsMemberWorkingTime getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasePsMemberWorkingTimeForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'ps_workingtime_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('PsWorkingTime'), 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ps_member_working_time[%s]');
