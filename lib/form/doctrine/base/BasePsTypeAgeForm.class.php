...
/**
 * PsTypeAge form base class.
 *
 * @method PsTypeAge getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasePsTypeAgeForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'start_month'     => new sfValidatorInteger(array('required' => false)),
      ...
      'stop_month'      => new sfValidatorInteger(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ps_type_age[%s]');
