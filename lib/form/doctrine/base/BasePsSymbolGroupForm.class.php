...
/**
 * PsSymbolGroup form base class.
 *
 * @method PsSymbolGroup getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasePsSymbolGroupForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'group_symbol'    => new sfWidgetFormInputText(),
      'is_type'         => new sfWidgetFormInputCheckbox(),
      'is_payment'      => new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      ...
      'group_symbol'    => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'is_type'         => new sfValidatorBoolean(array('required' => false)),
      'is_payment'      => new sfValidatorBoolean(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ps_symbol_group[%s]');
