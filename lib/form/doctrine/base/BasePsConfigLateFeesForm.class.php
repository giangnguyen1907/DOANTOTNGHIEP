...
/**
 * PsConfigLateFees form base class.
 *
 * @method PsConfigLateFees getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasePsConfigLateFeesForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'from_minute'     => new sfWidgetFormInputText(),
      'to_minute'       => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'from_minute'     => new sfValidatorInteger(array('required' => false)),
      'to_minute'       => new sfValidatorInteger(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ps_config_late_fees[%s]');
