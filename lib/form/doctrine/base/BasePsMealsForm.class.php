...
/**
 * PsMeals form base class.
 *
 * @method PsMeals getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasePsMealsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ps_meals[%s]');
