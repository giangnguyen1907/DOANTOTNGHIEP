...
/**
 * PsAlbumLike form base class.
 *
 * @method PsAlbumLike getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasePsAlbumLikeForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ps_album_like[%s]');
