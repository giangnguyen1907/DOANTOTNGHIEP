...
/**
 * FeatureOption form base class.
 *
 * @method FeatureOption getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseFeatureOptionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'servicegroup_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('ServiceGroup'), 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('feature_option[%s]');
