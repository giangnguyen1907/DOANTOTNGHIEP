...
/**
 * ServiceSplit form base class.
 *
 * @method ServiceSplit getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseServiceSplitForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('service_split[%s]');
