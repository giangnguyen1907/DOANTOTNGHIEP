...
abstract class BasesfGuardPermissionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'ps_app_permission_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('PsAppPermission'), 'required' => false)),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorAnd(array(
        ...
        new sfValidatorDoctrineUnique(array('model' => 'sfGuardPermission', 'column' => array('app_permission_code'))),
        new sfValidatorDoctrineUnique(array('model' => 'sfGuardPermission', 'column' => array('ps_app_permission_id'))),
      ))
    );
