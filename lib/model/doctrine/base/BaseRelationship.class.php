 ...
 * @property RelativeStudent $RelativeStudent
 ...
 * @method RelativeStudent getRelativeStudent() Returns the current record's "RelativeStudent" value
 ...
 * @method Relationship    setTitle()           Sets the current record's "title" value
 * @method Relationship    setDescription()     Sets the current record's "description" value
 * @method Relationship    setIorder()          Sets the current record's "iorder" value
 * @method Relationship    setIsActivated()     Sets the current record's "is_activated" value
 * @method Relationship    setUserCreatedId()   Sets the current record's "user_created_id" value
 * @method Relationship    setUserUpdatedId()   Sets the current record's "user_updated_id" value
 * @method Relationship    setRelativeStudent() Sets the current record's "RelativeStudent" value
 * @method Relationship    setUserCreated()     Sets the current record's "UserCreated" value
 * @method Relationship    setUserUpdated()     Sets the current record's "UserUpdated" value
 * 
...
abstract class BaseRelationship extends sfDoctrineRecord
{
    ...
    {
        parent::setUp();
        $this->hasOne('RelativeStudent', array(
             'local' => 'id',
