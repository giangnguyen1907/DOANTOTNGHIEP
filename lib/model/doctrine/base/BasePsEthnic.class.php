 ...
 * @method PsMember    getPsEthnics()       Returns the current record's "PsEthnics" value
 * @method PsEthnic    setTitle()           Sets the current record's "title" value
 * @method PsEthnic    setDescription()     Sets the current record's "description" value
 * @method PsEthnic    setIorder()          Sets the current record's "iorder" value
 * @method PsEthnic    setIsActivated()     Sets the current record's "is_activated" value
 * @method PsEthnic    setUserCreatedId()   Sets the current record's "user_created_id" value
 * @method PsEthnic    setUserUpdatedId()   Sets the current record's "user_updated_id" value
 * @method PsEthnic    setUserCreated()     Sets the current record's "UserCreated" value
 * @method PsEthnic    setUserUpdated()     Sets the current record's "UserUpdated" value
 * @method PsEthnic    setPsEthnics()       Sets the current record's "PsEthnics" value
 * 
 ...
 */
abstract class BasePsEthnic extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ps_ethnic');
    ...
    public function setUp()
    {
        ...
        $this->hasOne('PsMember as PsEthnics', array(
             'local' => 'id',
             'foreign' => 'ethnic_id'));
