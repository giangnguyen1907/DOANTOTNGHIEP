 ...
 * @method string        get()                Returns the current record's "group_symbol" value
 * @method boolean       get()                Returns the current record's "is_type" value
 * @method boolean       get()                Returns the current record's "is_payment" value
 ...
 * @method PsSymbolGroup set()                Sets the current record's "ps_customer_id" value
 * @method PsSymbolGroup set()                Sets the current record's "ps_workplace_id" value
 * @method PsSymbolGroup set()                Sets the current record's "title" value
 * @method PsSymbolGroup set()                Sets the current record's "note" value
 * @method PsSymbolGroup set()                Sets the current record's "group_symbol" value
 * @method PsSymbolGroup set()                Sets the current record's "is_type" value
 * @method PsSymbolGroup set()                Sets the current record's "is_payment" value
 * @method PsSymbolGroup set()                Sets the current record's "user_created_id" value
 * @method PsSymbolGroup set()                Sets the current record's "user_updated_id" value
 * 
 ...
 */
abstract class BasePsSymbolGroup extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ps_symbol_group');
        ...
        $this->hasColumn('group_symbol', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             ));
        ...
        $this->hasColumn('is_payment', 'boolean', null, array(
             'type' => 'boolean',
             'default' => 1,
             ));
