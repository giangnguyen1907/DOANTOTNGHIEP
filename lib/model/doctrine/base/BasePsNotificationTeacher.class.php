 ...
 * @method PsNotificationTeacher setTitle()          Sets the current record's "title" value
 * @method PsNotificationTeacher setNote()           Sets the current record's "note" value
 * @method PsNotificationTeacher setScreenCode()     Sets the current record's "screen_code" value
 * @method PsNotificationTeacher setModuleCode()     Sets the current record's "module_code" value
 * @method PsNotificationTeacher setItemId()         Sets the current record's "item_id" value
 * @method PsNotificationTeacher setIsRead()         Sets the current record's "is_read" value
 * @method PsNotificationTeacher setUserId()         Sets the current record's "user_id" value
 * @method PsNotificationTeacher setPsCustomerId()   Sets the current record's "ps_customer_id" value
 * @method PsNotificationTeacher setUsers()          Sets the current record's "Users" value
 * 
 ...
 */
abstract class BasePsNotificationTeacher extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ps_notification_teacher');
