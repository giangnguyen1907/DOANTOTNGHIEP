 ...
 * @method integer      get()                Returns the current record's "number" value
 ...
 * @method PsRegularity set()                Sets the current record's "ps_customer_id" value
 * @method PsRegularity set()                Sets the current record's "ps_workplace_id" value
 * @method PsRegularity set()                Sets the current record's "title" value
 * @method PsRegularity set()                Sets the current record's "number" value
 * @method PsRegularity set()                Sets the current record's "discount" value
 * @method PsRegularity set()                Sets the current record's "is_type" value
 * @method PsRegularity set()                Sets the current record's "user_created_id" value
 * @method PsRegularity set()                Sets the current record's "user_updated_id" value
 * 
 ...
 */
abstract class BasePsRegularity extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ps_regularity');
        ...
        $this->hasColumn('is_default', 'integer', null, array(
             'type' => 'integer',
             'default' => 1,
             ));
