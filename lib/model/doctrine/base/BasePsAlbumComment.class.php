 ...
 * @method PsAlbumComment setPsCustomerId()    Sets the current record's "ps_customer_id" value
 * @method PsAlbumComment setPsWorkplaceId()   Sets the current record's "ps_workplace_id" value
 * @method PsAlbumComment setAlbumId()         Sets the current record's "album_id" value
 * @method PsAlbumComment setRelativeId()      Sets the current record's "relative_id" value
 * @method PsAlbumComment setTitle()           Sets the current record's "title" value
 * @method PsAlbumComment setMedia()           Sets the current record's "media" value
 * @method PsAlbumComment setUserCreatedId()   Sets the current record's "user_created_id" value
 * @method PsAlbumComment setUserUpdatedId()   Sets the current record's "user_updated_id" value
 * 
 ...
 */
abstract class BasePsAlbumComment extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ps_album_comment');
