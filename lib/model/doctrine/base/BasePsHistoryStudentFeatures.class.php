 ...
 * @method PsHistoryStudentFeatures setStudentId()       Sets the current record's "student_id" value
 * @method PsHistoryStudentFeatures setTrackedAt()       Sets the current record's "tracked_at" value
 * @method PsHistoryStudentFeatures setPsAction()        Sets the current record's "ps_action" value
 * @method PsHistoryStudentFeatures setHistoryContent()  Sets the current record's "history_content" value
 * @method PsHistoryStudentFeatures setStudent()         Sets the current record's "Student" value
 * 
 ...
 */
abstract class BasePsHistoryStudentFeatures extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ps_history_student_features');
