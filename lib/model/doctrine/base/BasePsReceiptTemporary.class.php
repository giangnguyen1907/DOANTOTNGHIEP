 ...
 * @method PsReceiptTemporary setPsCustomerId()     Sets the current record's "ps_customer_id" value
 * @method PsReceiptTemporary setStudentId()        Sets the current record's "student_id" value
 * @method PsReceiptTemporary setTitle()            Sets the current record's "title" value
 * @method PsReceiptTemporary setReceiptDate()      Sets the current record's "receipt_date" value
 * @method PsReceiptTemporary setReceivable()       Sets the current record's "receivable" value
 * @method PsReceiptTemporary setCollectedAmount()  Sets the current record's "collected_amount" value
 * @method PsReceiptTemporary setBalanceAmount()    Sets the current record's "balance_amount" value
 * @method PsReceiptTemporary setIsCurrent()        Sets the current record's "is_current" value
 * @method PsReceiptTemporary setIsImport()         Sets the current record's "is_import" value
 * @method PsReceiptTemporary setPaymentStatus()    Sets the current record's "payment_status" value
 * @method PsReceiptTemporary setRelativeId()       Sets the current record's "relative_id" value
 * @method PsReceiptTemporary setNote()             Sets the current record's "note" value
 * @method PsReceiptTemporary setUserCreatedId()    Sets the current record's "user_created_id" value
 * @method PsReceiptTemporary setUserUpdatedId()    Sets the current record's "user_updated_id" value
 * @method PsReceiptTemporary setStudent()          Sets the current record's "Student" value
 * @method PsReceiptTemporary setRelative()         Sets the current record's "Relative" value
 * @method PsReceiptTemporary setPsCustomer()       Sets the current record's "PsCustomer" value
 * @method PsReceiptTemporary setUserCreated()      Sets the current record's "UserCreated" value
 * @method PsReceiptTemporary setUserUpdated()      Sets the current record's "UserUpdated" value
 * 
 ...
 */
abstract class BasePsReceiptTemporary extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ps_receipt_temporary');
