 ...
 * @method PsContract  setTitle()           Sets the current record's "title" value
 * @method PsContract  setDescription()     Sets the current record's "description" value
 * @method PsContract  setIorder()          Sets the current record's "iorder" value
 * @method PsContract  setIsActivated()     Sets the current record's "is_activated" value
 * @method PsContract  setUserCreatedId()   Sets the current record's "user_created_id" value
 * @method PsContract  setUserUpdatedId()   Sets the current record's "user_updated_id" value
 * @method PsContract  setUserCreated()     Sets the current record's "UserCreated" value
 * @method PsContract  setUserUpdated()     Sets the current record's "UserUpdated" value
 * @method PsContract  setPsMember()        Sets the current record's "PsMember" value
 * 
 ...
 */
abstract class BasePsContract extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ps_contract');
